...
namespace _20T1020657.Class
{
     class Function
    {
        ...
        {
            Connects = new SqlConnection();   //Khởi tạo đối tượng
            Connects.ConnectionString = @"Data Source=LAPTOP-6EIFMUG5;Initial Catalog=quanlybanhang;Integrated Security=True";
            Connects.Open();                  //Mở kết nối
            //Kiểm tra kết nối
        ...
        public static void Disconnect()
        {
            if (Connects.State == ConnectionState.Open)
            {
                Connects.Close();   	//Đóng kết nối
                Connects.Dispose(); 	//Giải phóng tài nguyên
                Connects = null;
            }
        }
        ...
        //phương thức thực thi câu lệnh thêm, cập nhật, xóa 
        public static void RunSQL(string sql, params SqlParameter[] parameters)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection("Data Source=LAPTOP-6EIFMUG5;Initial Catalog=quanlybanhang;Integrated Security=True"))
                {
                    connection.Open();
        ...
        public static System.Data.DataTable GetDataToTable(string sql, params SqlParameter[] parameters)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection("Data Source=LAPTOP-6EIFMUG5;Initial Catalog=quanlybanhang;Integrated Security=True"))
        ...
        internal static string GetFieldValues(string sql, params SqlParameter[] parameters)
        {
